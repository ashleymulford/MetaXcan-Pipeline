...
dos.add_argument("--geno_dir", help="Path to the directory containing genotype files in dosage format")
...
dos.add_argument("--sample_path", help="Path to the samples file")
dos.add_argument("--pheno_path", help="Path to the phenotype file")
...
if arg.gwas:
	...
	cutoff = " --cutoff_condition_number"+str(arg.cutoff_condition_number) if arg.cutoff_condition_number else \
		     ...
		     " --cutoff_eigen_ratio"+str(arg.cutoff_eigen_ratio) else ""
    mesa = " --mesa" if arg.mesa
	...
	os.system("python3 GWAS_pipeline.py --db_dir "+arg.db_dir+" --scripts_dir "+arg.software+" --gwas_file "+arg.gwas_file+cutoff+
              ...
              " --beta "+arg.beta_col+" --p_val "+arg.p+" --predi_out_dir "+arg.predi_out_dir+" --multi_out_dir"+arg.multi_out_dir+
...
os.system("python3 prep_outputs.py --assoc_out_dir "+arg.assoc_out_dir+" --multi_out_dir "+arg.multi_out_dir+
          " --out_prefix "+arg.out_prefix+" --pheno_prefix "+arg.pheno_prefix+" --pval "+arg.pval+gwas_flag)
