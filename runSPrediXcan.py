...
os.system("bash SPrediPipe.sh --snp rs --effect allele1 -noneffect allele0 --p_val p_wald -s /data/amulford/MetaXcan/software/SPrediXcan.py -m "+givenModelFolder+" --gwas "+givenGWASFile+" -o "+output)
